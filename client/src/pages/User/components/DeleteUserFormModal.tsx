        ...
        const handleDestroyUser = async (e: FormEvent) => {
            try {
                ...
                if(res.status === 200) {
                    ...
                    console.error('Unexpected status error occurred during deleting of user: ', res.status);
                }
            } catch(error) { 
    ...
    useEffect(() => {
        if(isOpen) {
            if(user) {
                ...
                console.error('Unexpected user error occurred during fetching user details: ', user)
            }
        }
        }, [isOpen, user]);
    ...
    <>
        ...
        <form onSubmit={handleDestroyUser}>
            ...
            <div className="grid grid-cols-2 gap-4 border-b border-gray-200 mb-4 px-4 pb-2">
                ...
                <div className="col-span-2 md:col-span-1">
                    <div className="mb-4">
                        <label htmlFor="birthdate" className="text-black font-medium mb-2">Birthdate</label>
